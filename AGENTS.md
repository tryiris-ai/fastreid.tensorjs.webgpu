# AGENTS.md — fastreid.tensorjs.webgpu
...
~/iris/ai.knowledge/rules/fastreid.tensorjs.webgpu/INDEX.md  (if exists)
~/iris/ai.knowledge/knowledge/global/INDEX.md
~/iris/ai.knowledge/knowledge/fastreid.tensorjs.webgpu/INDEX.md  (if exists)
```
...
Agent mistake → `/iris-rule global|fastreid.tensorjs.webgpu {rule}`
Explained something new → `/iris-learn global|fastreid.tensorjs.webgpu {context}`
